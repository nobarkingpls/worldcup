...
--
-- Name: games fk_games_opponenet; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_games_opponenet FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);
